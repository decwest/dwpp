#!/usr/bin/env python3
"""Minimal dependency-free assertions for the revision simulator."""
...
from scripts.revision.controllers import (
    _window_1d,
    calc_actual_velocity,
    compute_dynamic_window,
    evaluate_velocity_constraints,
)
from scripts.revision.simulator import DEFAULT_CONFIG
from scripts.revision.studies import run_smoke
...
def test_smoke() -> None:
    with __import__("tempfile").TemporaryDirectory(prefix="dwpp-revision-test-") as directory:
